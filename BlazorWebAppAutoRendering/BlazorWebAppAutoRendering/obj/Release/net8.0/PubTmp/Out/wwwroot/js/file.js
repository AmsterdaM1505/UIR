...
(function () {
    ...
    //const objects: Shape[] = [
    //    { type: 'rectangle', x: 50, y: 50, width: 50, height: 50, color: 'red', rotation: 0 } as Rectangle,
    //    { type: 'circle', x: 100, y: 150, radius: 25, color: 'blue', rotation: 0 } as Circle
    //];
    let objects = [];
    ...
    function processFileContent(content) {
        try {
            ...
            if (sizeMatch && objectsMatch) {
                ...
                //displayFileContent(size, shapes);
            }
            else {
    ...
    //function displayFileContent(size: any, shapes: Shape[]) {
    //    const fileContentElement = document.getElementById('fileContent');
    //    if (fileContentElement) {
    //        fileContentElement.textContent = `Size: ${JSON.stringify(size, null, 2)}\nShapes: ${JSON.stringify(shapes, null, 2)}`;
    //    }
    //}
    let ctx = null;
    if (canvas.getContext) {
        ...
        //            startX = x;
        //            startY = y;
        //            if (selectedObject.type === 'line' && selectedLineEnd) {
        //                const line = selectedObject as Line;
        //                if (selectedLineEnd === 'start') {
        //                    line.startX += dx;
        //                    line.startY += dy;
        //                } else if (selectedLineEnd === 'end') {
        //                    line.endX += dx;
        //                    line.endY += dy;
        //                }
        //            } else {
        ...
        //            selectedLineEnd = null;
        //        }
        //        function isInsideObject(x: number, y: number, obj: Shape) {
        //            if (obj.type === 'rectangle') {
        ...
        //                    (x - line.startX) ** 2 + (y - line.startY) ** 2
        //                );
        //                const distanceToEnd = Math.sqrt(
        //                    (x - line.endX) ** 2 + (y - line.endY) ** 2
        //                );
        //                return distanceToStart < 5 || distanceToEnd < 5;
        //            }
        //            return false;
        //        }
        // Функция для создания файла с данными и его скачивания
